...
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]keshvexff CODEX    
[FFD700]✨ Name on instagram : [FFFFFF] keshvexff❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> keshvexff BY keshvexff×CODEX ❄️  ⚡
"""
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To keshvexff ˣ ʙᴏᴛ"
...
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493]keshvexff by keshvexff×CODEX
...
async def MaiiiinE():
    Uid , Pw = '4339846520','0CD9606526A8988A3FC41E33DC5833C8A91A1B83308742E441381CE91B174BB6'
