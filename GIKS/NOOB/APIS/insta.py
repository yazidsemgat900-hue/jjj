# ------------------------------------------------------------
# Instagram Info API — Credit: KRISHNA (@KRISHNA)
# JOIN    : @KRISHNA  FOR MORE SRC | API | BOT CODE | METHOD | 🛐
# Purpose : Fetch profile & recent media (public + optional session-based)
# Note    : THIS CODE MADE BY KRISHNA @KRISHNA (GIVE CREDIT OTHERWISE EVERYONE FUCK YOU AT 300 KM SPEED)
