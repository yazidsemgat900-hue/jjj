...
#EMOTES BY keshvexff  X CODEX
# FIXED BY keshvexff  ❄️ 
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]KRISHN CODEX [00FF00]!!
"""
...
[FFFFFF]          ⚡ Inconnu_12_xp ❤️  
[FFFFFF]                   thank for support 
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]GIKS    
[FFD700]✨ Name on instagram : [FFFFFF] inconnu_12_xp❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> GIKS XIT VIP NTP BOT ❄️  ⚡
"""
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # Create spam packet
                                    spam_packet = await Room_Spam(target_uid, room_id, "keshvexff", key, iv)
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To GIKS v1 bot"
...
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493]GIKS VIP
[32CD32]║ 💻 Status        :: [32CD32]ONLINE
[1E90FF]║ 🛠 Version      :: [1E90FF]GIKS BOT V1
[00FFFA]╚═•══•════════════════•══•═╝"""
...
async def MaiiiinE():
    Uid , Pw = '4495271504','845499EFD442FDD9B05DB0E863066C34E1C6E27DBEB99B7EB12237E67DACF27F'
    ...
    os.system('clear')
    print("Initializing keshvexff Bot...")
    print("┌────────────────────────────────────┐")
    print("│ █████████████░░░░░░░░░░░░░░░░░░ │")
    print("└────────────────────────────────────┘")
    time.sleep(0.5)
    ...
    os.system('clear')
    print(render('keshvexff', colors=['white', 'green'], align='center'))
    print('')
    print("🤖 keshvexff BOT - ONLINE")
    print(f"🔹 UID: {TarGeT}")
    print(f"🔹 Name: {acc_name}")
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using keshvexff Bot")
    sys.exit(0)
